...
/*   Updated: 2024/02/12 13:12:35 by muhakose         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_strncmp(commands[0], "cd", 3) == FALSE)
		return (ft_cd(commands, env), TRUE);
	if (ft_strncmp(commands[0], "exit", 6) == FALSE)
		return (ft_exit(commands), TRUE);
	if (ft_strncmp(commands[0], "export", 7) == FALSE)
		return (ft_export(commands, env), TRUE);
	if (ft_strncmp(commands[0], "unset", 6) == FALSE)
		return (ft_unset(commands, env), TRUE);
	if (ft_strncmp(commands[0], "pwd", 4) == FALSE)
		return (ft_pwd(), TRUE);
	if (ft_strncmp(commands[0], "env", 4) == FALSE)
		return (ft_env(env), TRUE);
	if (ft_strncmp(commands[0], "echo", 5) == FALSE)
